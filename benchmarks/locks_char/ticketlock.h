...
static inline void await_for_ticket(struct ticketlock_s *l, char ticket)
{
...
{
    char o = atomic_load_explicit(&l->owner, memory_order_acquire);
    char n = atomic_compare_exchange_strong_explicit(&l->next, &o, o + 1,
...
{
    char owner = atomic_load_explicit(&l->owner, memory_order_relaxed);
